...
pub mod prelude {
    ...
    pub use crate::http::{
        ...
        lineage_router, query_router, schema_router, sensor_router, snapshots_router,
        AnomalyResponse, CommitBroadcaster, CommitStreamHttpState,
        ...
        SnapshotsHttpState, COMMIT_STREAM_CAPACITY,
    };
